...
from TOWN12.scenario_runner.srunner.scenariomanager.scenarioatomics.atomic_behaviors import WaitForever
from TOWN12.scenario_runner.srunner.scenariomanager.carla_data_provider import CarlaDataProvider
from TOWN12.scenario_runner.srunner.scenariomanager.timer import TimeOut
from TOWN12.scenario_runner.srunner.scenariomanager.scenarioatomics.atomic_behaviors import UpdateAllActorControls
from TOWN12.scenario_runner.srunner.scenariomanager.scenarioatomics.atomic_criteria import Criterion
...
class BasicScenario(object):
    ...
    def __init__(self, name, ego_vehicles, config, world, randomize=False,
                 debug_mode=False, terminate_on_failure=False, criteria_enable=False, uniad=False, interfuser=False):
        """
    ...
    def _tf_set_ego_route(self, route):
        if self._check_tf():
