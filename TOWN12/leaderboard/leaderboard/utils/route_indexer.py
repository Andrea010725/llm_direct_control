...
from TOWN12.leaderboard.leaderboard.utils.route_parser import RouteParser
from TOWN12.leaderboard.leaderboard.utils.checkpoint_tools import fetch_dict
...
class RouteIndexer():
    ...
    def validate_and_resume(self, endpoint):
        ...
        self.index = max(0, progress[0])  # Resume means something went wrong, repeat the last route
        return True
