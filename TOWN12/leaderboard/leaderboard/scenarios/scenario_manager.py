...
# from TOWN12.leaderboard.leaderboard.autoagents.agent_wrapper import AgentWrapperFactory, AgentError
from TOWN12.leaderboard.leaderboard.autoagents.agent_wrapper_local import AgentWrapperFactory, AgentError
from TOWN12.leaderboard.leaderboard.envs.sensor_interface import SensorReceivedNoData
from TOWN12.leaderboard.leaderboard.utils.result_writer import ResultOutputProvider
...
class ScenarioManager(object):
    ...
    def _tick_scenario(self):
        ...
        if self._timestamp_last_run < timestamp.elapsed_seconds and self._running:
            ...
            self._spectator.set_transform(carla.Transform(ego_trans.location + carla.Location(z=20),
