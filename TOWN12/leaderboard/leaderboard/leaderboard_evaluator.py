...
from TOWN12.scenario_runner.srunner.scenariomanager.carla_data_provider import *
from TOWN12.scenario_runner.srunner.scenariomanager.timer import GameTime
from TOWN12.scenario_runner.srunner.scenariomanager.watchdog import Watchdog

from TOWN12.leaderboard.leaderboard.scenarios.scenario_manager import ScenarioManager
from TOWN12.leaderboard.leaderboard.scenarios.route_scenario_local import RouteScenario
from TOWN12.leaderboard.leaderboard.envs.sensor_interface import SensorConfigurationInvalid
from TOWN12.leaderboard.leaderboard.autoagents.agent_wrapper_local import AgentError, validate_sensor_configuration
from TOWN12.leaderboard.leaderboard.utils.statistics_manager import StatisticsManager
from TOWN12.leaderboard.leaderboard.utils.route_indexer import RouteIndexer
...
class LeaderboardEvaluator(object):
    ...
    def __init__(self, args, statistics_manager):
        ...
        self.traffic_manager = self.client.get_trafficmanager(args.trafficManagerPort)
    ...
    def _load_and_wait_for_world(self, args, town):
        ...
        CarlaDataProvider.set_traffic_manager_port(args.trafficManagerPort)
    ...
    def _load_and_run_scenario(self, args, config):
        ...
        try:
            ...
            if getattr(agent_class_obj, 'get_ros_version')() == 1 and self._ros1_server is None:
                from TOWN12.leaderboard.leaderboard.autoagents.ros1_agent import ROS1Server
                self._ros1_server = ROS1Server()
                self._ros1_server.start()

            self.agent_instance = agent_class_obj(args.host, args.port, args.debug)
            self.agent_instance.set_global_plan(scenario.gps_route, scenario.route, scenario.wp_route)
            self.agent_instance.setup(args.agent_config, route_name=route_name)
            CarlaDataProvider._agent_instance = self.agent_instance
