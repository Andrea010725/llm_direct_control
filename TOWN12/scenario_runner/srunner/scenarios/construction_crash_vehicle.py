...
from TOWN12.scenario_runner.srunner.tools.background_manager import (RemoveRoadLane,
                                              ReAddRoadLane,
                                              SetMaxSpeed,
...
class ConstructionObstacle(BasicScenario):
    ...
    def _initialize_actors(self, config):
        ...
        scenario_end_wp = self._move_waypoint_forward(self._construction_wp, 15)
