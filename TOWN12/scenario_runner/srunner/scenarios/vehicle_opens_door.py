...
from TOWN12.scenario_runner.srunner.scenariomanager.scenarioatomics.atomic_behaviors import (ActorDestroy,
                                                                      ...
                                                                      Idle,
                                                                      OppositeActorFlow)
from TOWN12.scenario_runner.srunner.scenariomanager.scenarioatomics.atomic_trigger_conditions import (InTriggerDistanceToLocation,
                                                                               InTimeToArrivalToLocation,
                                                                               DriveDistance,
                                                                               WaitUntilInFrontPosition)
from TOWN12.scenario_runner.srunner.scenarios.basic_scenario import BasicScenario

from TOWN12.scenario_runner.srunner.tools.background_manager import LeaveSpaceInFront, ChangeOppositeBehavior
...
class VehicleOpensDoorTwoWays(BasicScenario):
    ...
    def _initialize_actors(self, config):
        ...
        CarlaDataProvider._scenario_start_wp = self._parked_wp
        ...
        scenario_end_wp = self._move_waypoint_forward(self._front_wp, 5)
