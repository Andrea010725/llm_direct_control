...
class GlobalConfig:
	...
	root_dir_all = "/home/wupenghao/transfuser/data_extra/roach_ap_data_collect_nonoise_all"
	...
	for i in range(8):
		train_data.append(os.path.join(root_lb2, 'routes_training_split_{}'.format(i)))


	for i in range(2):
		val_data.append(os.path.join(root_lb2, 'routes_devtest_split_{}'.format(i)))
	...
	# for town in train_towns:
		...
		# train_data.append(os.path.join(root_dir_all, town+'_tiny'))
	...
	# train_data.append(os.path.join(root_dir_all, "town05_addition"))
	# train_data.append(os.path.join(root_dir_all, "town10_addition"))
	...
	rl_ckpt = "/home/wupenghao/transfuser/roach/log/ckpt_11833344.pth"
